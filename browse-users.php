                        ...
                        <div class="card mb-1" style="max-width: 540px; padding-right: 35px">
                            <div class="d-flex align-items-center">
                                <div>
                                    ...
                                    <?php } else { ?>
                                        <a href="profile.php?user_id=<?php echo $row["id"] ?>">
                                            <img src="<?php echo $row["profile_picture"] ?>" class="rounded-circle m-1 follow-insight-user-img" alt="...">
                                        </a>
                                    <?php } ?>
                                </div>
                                <div>
                                    <div class="card-body">
                                        ...
                                        <p class="card-text">
                                            <?php
                                            if (strlen($row["about"]) > 40) {
                                                echo substr($row["about"], 0, 40) . "...";
                                            } else {
                                                echo $row["about"];
                                            }
                                            ?></p>
