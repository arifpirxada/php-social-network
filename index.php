        ...
        <div class="post-item">
          <div class="card mb-3">
            ...
            <div class="card-body">
              ...
              <p class="card-text">⏰ Feeling overwhelmed? You won't believe this simple trick that's boosted my focus!
        ...
        <div class="post-item">
          <div class="card mb-3">
            ...
            <div class="card-body">
              ...
              <p class="card-text">boosted my focus! Lorem ipsum dolor sit amet. #productivitytips #timemanagement.</p>
            </div>
            <div class="post-actions d-flex justify-content-around my-4">
              <button class="mx-1 bg-transparent border-0"><img width="30" height="30" class="mx-2" src="img/icons/like-icon.png" alt="">Like</button>
              <button class="bg-transparent border-0"><img width="30" height="30" class="mx-2" src="img/icons/share-icon.png" alt="">Share</button>
        ...
        <div class="post-item">
          <div class="card mb-3">
            ...
            <div class="card-body">
              ...
              <p class="card-text">Simple trick that's Lorem ipsum dolor sit amet consectetur, adipisicing elit.!
                #productivitytips #timemanagement.</p>
            </div>
            <div class="post-actions d-flex justify-content-around my-4">
              <button class="mx-1 bg-transparent border-0"><img width="30" height="30" class="mx-2" src="img/icons/like-icon.png" alt="">Like</button>
